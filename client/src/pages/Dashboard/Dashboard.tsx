  ...
  return (
    <>
      ...
      <main className="grid grid-cols-2 relative">
        ...
        <div className="fixed bottom-4 right-4 h-10 w-10 rounded-full grid place-content-center bg-main text-2xl hover:scale-110 transition-all border border-white">
          +
        </div>
        {/* <PopUpModal /> */}
      </main>
